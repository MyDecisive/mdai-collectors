...
COPY .. .
RUN CGO_ENABLED=0 GOOS=${TARGETOS} GOARCH=${TARGETARCH} /app/builder --config=config/mdai-data-filtration-collector/mdai-data-filtration-collector-builder.yaml

# FROM scratch
FROM scratch
ARG VARIANT
COPY --from=builder app/cmd/mdai-data-filtration-collector /
COPY --from=certs /etc/ssl/certs/ca-certificates.crt /etc/ssl/certs/ca-certificates.crt
EXPOSE 4317/tcp 4318/tcp 8126/tcp 8891/tcp 8899/tcp 13133/tcp
USER 65533:65533
ENTRYPOINT ["/mdai-data-filtration-collector"]
