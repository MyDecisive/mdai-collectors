...
require (
	github.com/decisiveai/mdai-collectors/attributeextractorconnector v0.1.3
...
replace github.com/decisiveai/mdai-collectors/attributeextractorconnector => ../../attributeextractorconnector
